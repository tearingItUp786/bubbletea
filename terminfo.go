...
func defaultTerminfoKeys(flags int) map[string]KeyMsg {
	keys := map[string]KeyMsg{
		"kcuu1": {Sym: KeyUp},
	...
	if flags&FlagFKeys != 0 {
		keys["kf13"] = KeyMsg{Sym: KeyF13}
		keys["kf14"] = KeyMsg{Sym: KeyF14}
		keys["kf15"] = KeyMsg{Sym: KeyF15}
		keys["kf16"] = KeyMsg{Sym: KeyF16}
		keys["kf17"] = KeyMsg{Sym: KeyF17}
		keys["kf18"] = KeyMsg{Sym: KeyF18}
		keys["kf19"] = KeyMsg{Sym: KeyF19}
		keys["kf20"] = KeyMsg{Sym: KeyF20}
		keys["kf21"] = KeyMsg{Sym: KeyF21}
		keys["kf22"] = KeyMsg{Sym: KeyF22}
		keys["kf23"] = KeyMsg{Sym: KeyF23}
		keys["kf24"] = KeyMsg{Sym: KeyF24}
		keys["kf25"] = KeyMsg{Sym: KeyF25}
		keys["kf26"] = KeyMsg{Sym: KeyF26}
		keys["kf27"] = KeyMsg{Sym: KeyF27}
		keys["kf28"] = KeyMsg{Sym: KeyF28}
		keys["kf29"] = KeyMsg{Sym: KeyF29}
		keys["kf30"] = KeyMsg{Sym: KeyF30}
		keys["kf31"] = KeyMsg{Sym: KeyF31}
		keys["kf32"] = KeyMsg{Sym: KeyF32}
		keys["kf33"] = KeyMsg{Sym: KeyF33}
		keys["kf34"] = KeyMsg{Sym: KeyF34}
		keys["kf35"] = KeyMsg{Sym: KeyF35}
		keys["kf36"] = KeyMsg{Sym: KeyF36}
		keys["kf37"] = KeyMsg{Sym: KeyF37}
		keys["kf38"] = KeyMsg{Sym: KeyF38}
		keys["kf39"] = KeyMsg{Sym: KeyF39}
		keys["kf40"] = KeyMsg{Sym: KeyF40}
		keys["kf41"] = KeyMsg{Sym: KeyF41}
		keys["kf42"] = KeyMsg{Sym: KeyF42}
		keys["kf43"] = KeyMsg{Sym: KeyF43}
		keys["kf44"] = KeyMsg{Sym: KeyF44}
		keys["kf45"] = KeyMsg{Sym: KeyF45}
		keys["kf46"] = KeyMsg{Sym: KeyF46}
		keys["kf47"] = KeyMsg{Sym: KeyF47}
		keys["kf48"] = KeyMsg{Sym: KeyF48}
		keys["kf49"] = KeyMsg{Sym: KeyF49}
		keys["kf50"] = KeyMsg{Sym: KeyF50}
		keys["kf51"] = KeyMsg{Sym: KeyF51}
		keys["kf52"] = KeyMsg{Sym: KeyF52}
		keys["kf53"] = KeyMsg{Sym: KeyF53}
		keys["kf54"] = KeyMsg{Sym: KeyF54}
		keys["kf55"] = KeyMsg{Sym: KeyF55}
		keys["kf56"] = KeyMsg{Sym: KeyF56}
		keys["kf57"] = KeyMsg{Sym: KeyF57}
		keys["kf58"] = KeyMsg{Sym: KeyF58}
		keys["kf59"] = KeyMsg{Sym: KeyF59}
		keys["kf60"] = KeyMsg{Sym: KeyF60}
		keys["kf61"] = KeyMsg{Sym: KeyF61}
		keys["kf62"] = KeyMsg{Sym: KeyF62}
		keys["kf63"] = KeyMsg{Sym: KeyF63}
	}
